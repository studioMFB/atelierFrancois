...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      `.replace("#include <dithering_fragment>",`#include <dithering_fragment>
        ...
        `)},this.mesh=new Rt(this.geometry,this.material),this.mesh.name=this.name,this.mesh.position.set(this.pos.x,this.pos.y,this.pos.z)}tick(e){}}class xE extends Rt{constructor(e,t,i,r){super(),this.name=e,this.dim=t,this.seg=i,this.pos=r}initMesh(e,t){this.geometry=new cs(this.dim.x,this.dim.z),this.geometry.rotateX(-Math.PI/2),this.material=new yo({color:e,opacity:t,transparent:!0}),this.mesh=new Rt(this.geometry,this.material),this.mesh.name=this.name,this.mesh.position.set(this.pos.x,this.pos.y,this.pos.z)}tick(e){}}var Ga;(n=>{n.createEventHub=()=>({hub:Object.create(null),fire(e,t){(this.hub[e]||[]).forEach(i=>i(t))},on(e,t){this.hub[e]||(this.hub[e]=[]),this.hub[e].push(t)},off(e,t){const i=(this.hub[e]||[]).findIndex(r=>r===t);i>-1&&this.hub[e].splice(i,1),this.hub[e].length===0&&delete this.hub[e]}})})(Ga||(Ga={}));const ma=20,ME=40,Vr=2,ju=Vr*.5,Ku=new N(2,.5,2),SE=0,EE=.25,so=Ga.createEventHub();class yE{constructor(e){this.meshArray=[],this.isShiftDown=!1,this.sceneController=new QS,this.scene=this.sceneController.init(new Ve("#17181b")),this.renderer=new Fd({antialias:!0}),this.renderer.setPixelRatio(window.devicePixelRatio),this.renderer.setSize(window.innerWidth,window.innerHeight),e.appendChild(this.renderer.domElement),this.cameraController=new $S(new N(0,15,15)),this.camera=this.cameraController.init(),this.controlsController=new KS(this.camera,e),this.controlsController.init(),new eE(this.camera,this.renderer),new ZS().init(this.scene,new Ve(16777215),new Ve(5437322)),this.loopController=new JS(this.camera,this.scene,this.renderer),this.gridController=new tE(ma,ME),this.gridController.init(this.scene),this.raycaster=new XS,this.pointer=new Ne,this.planeController=new nE("T-Plane",new Ne(ma,ma),new Ne(1,1),new N(0,0,0)),this.planeController.initMesh(!1),this.addObject(this.planeController),this.terrainGhost=new xE("T-Ghost",Ku,new N(50,1,50),new N(0,0,0)),this.terrainGhost.initMesh(new Ve(16711680),.5),this.terrainGhost.mesh&&(this.sceneController.addMesh(this.terrainGhost.mesh),this.loopController.addToUpdate(this.terrainGhost)),this.init()}init(){this.addObject(this.controlsController),this.addObject(this.cameraController),document.addEventListener("keydown",e=>{this.onDocumentKeyDown(e)}),document.addEventListener("keyup",e=>{this.onDocumentKeyUp(e)}),so.on("spawnTerrain",()=>document.addEventListener("pointermove",e=>{this.onPointerMove(e)})),so.on("dropTerrain",e=>this.onPointerDown(e))}render(){this.renderer.render(this.scene,this.camera)}start(){this.loopController.start()}stop(){this.loopController.stop()}addObject(e){if(!e){console.log("Object is null or undifined and will not be added to the scene!");return}e.mesh&&(this.sceneController.addMesh(e.mesh),this.meshArray.push(e.mesh)),this.loopController.addToUpdate(e)}onPointerMove(e){console.log("OnPointerMove =>"),this.controlsController.controls.enabled=!1,this.pointer.set(e.clientX/window.innerWidth*2-1,-(e.clientY/window.innerHeight)*2+1),this.raycaster.setFromCamera(this.pointer,this.camera);const t=this.raycaster.intersectObjects(this.meshArray,!1);if(t&&t.length>0){const i=t[0];this.terrainGhost&&this.terrainGhost.mesh&&i&&i.face&&(this.terrainGhost.mesh.position.copy(i.point).add(i.face.normal),this.terrainGhost.mesh.position.divideScalar(Vr).floor().multiplyScalar(Vr).addScalar(ju),this.terrainGhost.mesh.position.y=SE),this.render()}}onPointerDown(e){console.log("OnPointerDown =>"),this.raycaster.setFromCamera(this.pointer,this.camera);const t=this.raycaster.intersectObjects(this.meshArray,!1);if(t&&t.length>0){const i=t[0];if(this.isShiftDown)i.object&&i.object!==this.planeController.mesh&&(this.scene.remove(i.object),this.meshArray.splice(this.meshArray.indexOf(i.object),1));else{const r=new vE("T01",Ku,new N(50,1,50),new N(0,0,0));r.initMesh("mountain",e),r.mesh&&i&&i.face&&(r.mesh.position.copy(i.point).add(i.face.normal),r.mesh.position.divideScalar(Vr).floor().multiplyScalar(Vr).addScalar(ju),r.mesh.position.y=EE),this.addObject(r)}this.render()}this.controlsController.controls.enabled=!0,document.removeEventListener("pointermove",this.onPointerMove)}onDocumentKeyDown(e){switch(e.keyCode){case 16:this.isShiftDown=!0;break}}onDocumentKeyUp(e){switch(e.keyCode){case 16:this.isShiftDown=!1;break}}}const bE={class:"menu"},TE=pt("div",{class:"menu__title"},[pt("p",null,"Terrains")],-1),AE={id:"menu__resources",class:"menu__resources"},wE={class:"menu__resources--tile",tabindex:"1"},CE={class:"menu__resources--btn"},RE=["src"],LE={class:"menu__resources--tile",tabindex:"2"},PE={class:"menu__resources--btn"},DE=["src"],UE={class:"menu__resources--tile",tabindex:"3"},IE={class:"menu__resources--btn"},NE=["src"],OE={class:"menu__resources--tile",tabindex:"3"},FE={class:"menu__resources--btn"},BE=["src"],zE=Sh({__name:"ResourceExplorer",setup(n){const e=new URL("./dist/assets/thumb-4f930de4.png",self.location).toString(),t=new URL("./dist/assets/thumb-e08c5e7d.png",self.location).toString(),i=new URL("./dist/assets/thumb-424cb668.png",self.location).toString();function r(){setTimeout(()=>{let s=new Zi(document.getElementById("menu__resources"),{draggable:"li.menu__resources--tile"});s.on("drag:start",a=>{so.fire("spawnTerrain","")}),s.on("drag:stop",a=>{const o=a.source;console.log("TILE ",o),so.fire("dropTerrain",o.tabIndex)})},500)}return r(),(s,a)=>(Uh(),Op("div",bE,[TE,pt("ul",AE,[pt("li",wE,[pt("button",CE,[pt("img",{class:"menu__resources--img",title:"t1",src:zr(e)},null,8,RE)])]),pt("li",LE,[pt("button",PE,[pt("img",{class:"menu__resources--img",title:"t2",src:zr(t)},null,8,DE)])]),pt("li",UE,[pt("button",IE,[pt("img",{class:"menu__resources--img",title:"t3",src:zr(i)},null,8,NE)])]),pt("li",OE,[pt("button",FE,[pt("img",{class:"menu__resources--img",title:"t3",src:zr(i)},null,8,BE)])])])]))}});const HE=Sh({__name:"App",setup(n){return(e,t)=>(Uh(),Fp(zE))}});async function GE(){const n=document.getElementById("App");new yE(n).start()}Mm(HE).mount("#App");GE();
