...
<template>
    <div v-if="renderer">
        ...
        <MainScene :colour="new Color(0xded6d8)">
            <template>
                <HemisphereLight :sky-colour="new Color(0xffffff)" :ground-colour="new Color(0xffffff)"
                    :intensity="1.05"></HemisphereLight>
                ...
                <PlaneGeometry :dimension="new THREE.Vector2(GRID_SIZE, GRID_SIZE)" :segment="new THREE.Vector2(1,1)"> </PlaneGeometry>
