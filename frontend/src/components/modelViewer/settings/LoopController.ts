...
export class LoopController {
  ...
  resolveOverlap(object1:Group<Object3DEventMap>, box1:Box3, object2:Group<Object3DEventMap>, box2:Box3) {
  ...
  restricMoveToBoundaries(object:Group<Object3DEventMap>, box:Box3) {
