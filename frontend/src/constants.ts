...
export const GLTF_URL = {
    TABLE: new URL('@/assets/models/furniture/tables/table_001.glb', import.meta.url).toString(),
    BENCH: new URL('@/assets/models/furniture/benches/bench_001.glb', import.meta.url).toString(),
