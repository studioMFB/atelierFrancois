import { DoubleSide, Mesh, Vector3, PlaneGeometry, Vector2, Color, MeshStandardMaterial, WebGLRenderTarget, MeshBasicMaterial, ShadowMaterial, BoxGeometry, BufferGeometry, Scene, MeshLambertMaterial, Shape, ExtrudeGeometry, Group } from "three";
